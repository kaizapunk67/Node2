...
To start server in localhost, port 3000 with 24 hours expiry for token
...
# Delayed End Points (2 to 8 seconds delay)
    ...
    http://localhost:3000/delayed/api/products
    http://localhost:3000/delayed/api/brands
    http://localhost:3000/delayed/api/cities
    http://localhost:3000/delayed/api/states
    http://localhost:3000/delayed/api/stores
...
The below APIs must be having Authorization header with "JWT \" for all GET, POST, PUT, DELETE requests
    ...
    http://localhost:3000/secured/api/products
    http://localhost:3000/secured/api/brands
    http://localhost:3000/secured/api/cities
    http://localhost:3000/secured/api/states
    http://localhost:3000/secured/api/stores
...
Use below API for same 
    ...
    http://localhost:3000/api/exist/users/username/admin10
        

    http://localhost:3000/api/exist/products/id/1000

    
    The syntax is 
    
    http://localhost:3000/api/exist/collection-name/fieldname/expected-value
...
For Errors
    ...
    http://localhost:3000/logs/errors

For activities log,

    http://localhost:3000/logs/activities
